...
export function CodeFigure({ children, ...props }: ComponentProps<"figure">) {
  ...
  return (
    ...
    >
      <div className="flex items-center justify-end border-b border-[rgba(20,23,28,0.1)] bg-[#f7f7f6] px-2 py-1.5">
...
export function CodePre({ children, ...props }: ComponentProps<"pre">) {
  return (
    <InsidePreContext.Provider value={true}>
      <pre
        {...props}
        className="m-0 overflow-x-auto px-[18px] pt-[18px] pb-5 font-mono text-[12.5px] leading-[1.75] whitespace-pre text-[#26303f]"
      >
        {children}
      </pre>
